...
This project is indexed by GitNexus as **smart-air** (14536 symbols, 32898 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
