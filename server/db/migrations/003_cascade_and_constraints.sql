...
-- devices.room_id -> SET NULL (delete room -> unassign device, do not delete it)
...
-- devices.type_id -> SET NULL (if device type is removed, device stays)
...
-- devices.owner_id -> SET NULL (device survives if registrar is deleted)
